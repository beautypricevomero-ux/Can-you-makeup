    ...
    <html lang="it">
      <body className="app-body text-slate-900">
        <div className="relative flex min-h-screen min-h-[100svh] flex-col overflow-hidden">
          <div className="pointer-events-none absolute -left-32 top-32 hidden h-80 w-80 rounded-full bg-pink-300/35 blur-3xl md:block" />
          <div className="pointer-events-none absolute -right-24 top-1/3 hidden h-96 w-96 rounded-full bg-fuchsia-200/35 blur-[120px] lg:block" />
          <Navbar />
          <main
